    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BuyOdrderId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SellOdrderId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    StockId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PortfolioId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Symbol = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Quantity = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Stocks",
                columns: new[] { "Id", "CompanyName", "CurrentPrice", "LastUpdated", "Sector", "Symbol" },
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), "Apple Inc.", 200.00m, new DateTime(2026, 1, 1, 15, 19, 20, 690, DateTimeKind.Utc).AddTicks(4650), "Technology", "AAPL" },
                    { new Guid("22222222-2222-2222-2222-222222222222"), "JP Morgan Chase", 150.00m, new DateTime(2026, 1, 1, 15, 19, 20, 690, DateTimeKind.Utc).AddTicks(4673), "Finance", "JPM" }
                });
